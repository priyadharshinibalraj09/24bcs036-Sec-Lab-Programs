...
function validateForm(){
    ...
    if (nameError === "Name is valid" && emailError === "email is valid"  && password === "Password is valid" && phoneError === "PhoneNumber is valid") {
        return true;
    }
    ...
    document.getElementById("phoneError").innerText = phoneError === "PhoneNumber is valid" ? "" :phoneError;
